...
const SCENARIOS = {
  ...
  tower_a4: {
    id: "tower_a4", titleKey: "sc_tower_a4", series:"tower", quiz:true, gate:"tower_t1",
    levels: [
      ...
      { sec:"lvHold", trick:"holdfast",
        stars:[{x:0.18,y:0.26},{x:0.37,y:0.58},{x:0.55,y:0.36},{x:0.72,y:0.72},{x:0.88,y:0.30}],
        text:{ tag:"qtA4bTag", riddle:"qtA4bRiddle", hint:"qtA4bHint", reveal:"qtReveal" },
        hints:["qtA4bH1","qtA4bH2","qtA4bH3"] },
      { sec:"lvHold", trick:"holdfast",
        stars:[{x:0.12,y:0.60},{x:0.28,y:0.24},{x:0.45,y:0.48},{x:0.62,y:0.22},{x:0.76,y:0.64},{x:0.90,y:0.40}],
        text:{ tag:"qtA4cTag", riddle:"qtA4cRiddle", hint:"qtA4cHint", reveal:"qtReveal" },
        hints:["qtA4cH1","qtA4cH2","qtA4cH3"] },
    ],
